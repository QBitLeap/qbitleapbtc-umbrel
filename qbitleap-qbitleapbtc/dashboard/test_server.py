...
class ExpectedHashrateTests(unittest.TestCase):
    ...
    def test_render_prompts_for_detected_worker_without_examples(self):
        ...
        self.assertIn("AuxPoW Backend", page)
        self.assertIn("Permissionless Qbit Backend", page)
        self.assertIn("Selectable on local port 3335", page)
        self.assertIn("Rental AuxPoW Stratum", page)
        self.assertIn("Port 4335 · minimum difficulty 500,000", page)
